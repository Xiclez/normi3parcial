<template>
  <div id="app">
    ...
    <h2 id = "TITLE1" v-if="!juegoIniciado">¿Eres el mejor maestro pokemon del mundo?</h2>
    <h3 id = "TITLE2" v-if="!juegoIniciado">Memoriza la mayor cantidad de Pokemons y demuestralo!!</h3>

    <div  v-if="!juegoFinalizado">
      <h1 id = "TITLE3" v-if="!juegoIniciado">Equipo elegido para esta ronda:</h1>
